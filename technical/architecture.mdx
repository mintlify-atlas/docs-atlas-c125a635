...
The RAADS-R Self-Host application is built with **React 18** and **TypeScript**, using a component-based architecture with custom hooks for state management. The application follows a single-page application (SPA) pattern with client-side routing through screen state.
